	...
	init = function(model)
		model.cell = Cell{
			...
			execute = function(cell)
                ...
                -- Mutation 1: Negate Cond (ROR5)
                -- elseif cell.state ~= "burning" then ... orig
				elseif cell.state == "burning" then
				
				   -- Mutation 2: Relational Operator Replacement (ROR2: < => >)
				   -- if Random():number()< model.b then ... orig
...
for i=1,120 do
  ...
  scene.map:save("Fire_mutant_" .. value .. i .. ".png")
  --else
