...
function sel_values(i)
   ...
   local inff = {100, 5, 15, 25, 250, 500, 1000}
   local socf = {10, 15, 20, 50, 100, 250, 500}
   local rdif = {1, 2, 3, 4, 6, 8, 10}
   local revf = {0.2, 0.000001, 0.00001, 0.01, 0.3, 0.4, 0.999999}
...
for i=1,49 do
  ...
  scene.chart:save("Ants_mutant_" .. value .. i .. ".png") 
