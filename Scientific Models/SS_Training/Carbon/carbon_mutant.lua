...
Deforestation = 3,
    ...
    execute = function(self)
        ...
        -- Mutation 1: Arithmetic Operator Replacement (AOR1: * => /)
        -- self.Photosynthesis = ((self.TerrestrialBiosphere*0.1483)+(self.ATMOSPHERE/700))*self.Season ... original
        self.Photosynthesis = ((self.TerrestrialBiosphere/0.1483)+(self.ATMOSPHERE/700))*self.Season
        
        -- Mutation 2: Arithmetic Operator Replacement (AOR1: / => *)
        --  self.Death = 0.05/self.TerrestrialBiosphere ... orig
...
for i=1,120 do
  ...
  scene:run() 
     ...
     scene.chart2:save("Carbon_mutant_" .. value .. i .. ".png") 
